...
lhs6328_fits = fits.open(
    'example_use_cases/sprat_LHS6328_Hiltner102_raw/v_e_20180810_12_1_0_2.fits.gz')[3]
hilt102_fits = fits.open(
    'example_use_cases/sprat_LHS6328_Hiltner102_raw/v_s_20180810_27_1_0_2.fits.gz')[3]
